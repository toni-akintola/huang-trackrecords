...
class HuangTrackRecord:
    ...
    def update_credences(self, node_data, coin_flip):
    ...
    def bayesian_update(self, node_data, coin_flip):
    ...
    def record_track(self, node_data):
